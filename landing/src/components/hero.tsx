...
export function HeroCopy() {
  return (
    <>
      <h1 className="text-[42px] leading-[1.20] font-[650] tracking-[-0.045em] text-pretty text-strong desktop:max-w-[640px] desktop:text-[64px] desktop:leading-[1.1]">
        Craft, studied at 25,600<span className="text-accent">%</span>
      </h1>
      <p className="mt-8 text-sm leading-6 text-pretty text-muted desktop:mt-6 desktop:max-w-[560px] desktop:text-[15.5px] desktop:leading-[1.6]">
